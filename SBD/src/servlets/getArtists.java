	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				art = ArtistaDAO.selectAllArtistas();
				...
				for (Artista a : art) {
					...
					int numRes = ArtistaDAO.getArtistaNumRecursos(a.getnomeArtista());
					ArrayList<String> prof = Artista_RecursoDAO.getProfissaoByArtista(a.getnomeArtista());
			
					recursosString += a.toString();
					recursosString += ", count = " + numRes;
					recursosString += ", profissoes = ";
					for (String p : prof) {
						recursosString += p + "+";
					}
					recursosString += "|";
