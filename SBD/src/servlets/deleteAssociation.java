	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				String input = request.getParameter("grupo");
				
				int idGrupo = Integer.parseInt(input);
				
				boolean deleted = Grupo_RecursoDAO.deleteAssociation(idGrupo);
				...
				if (deleted) {
					...
					resultJSON.put("data", "AssociaÁ„o eliminada com sucesso");
					out.write(resultJSON.toString());
					out.flush();	
				...
				resultJSON.put("success", true);
				resultJSON.put("data", "Ocurreu um erro. Tente novamente mais tarde");
				out.write(resultJSON.toString());
				out.flush();	
