...
@WebServlet("/searchPopulars")
public class searchPopulars extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public searchPopulars () {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				res = RecursoDAO.getNRecursosOrderByClassificacao(8, idadeParaFaixaEtaria);
