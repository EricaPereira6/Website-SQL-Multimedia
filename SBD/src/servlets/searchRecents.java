...
@WebServlet("/searchRecents")
public class searchRecents extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public searchRecents () {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				res = RecursoDAO.getNRecursosOrderByDataPublicacao(8, idadeParaFaixaEtaria);
