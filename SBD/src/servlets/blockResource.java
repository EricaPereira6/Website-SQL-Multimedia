	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				Recurso res = RecursoDAO.getRecursoByTituloAndCarregadoPor(title, publisher);
				
				Boolean success = RecursoDAO.blockOrUnblockRecurso(title, publisher, !res.getBloqueado());
				String blocked = (!res.getBloqueado()) ? "Desbloquear" : "Bloquear";
