...
@WebServlet("/searchRecommended")
public class searchRecommended extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public searchRecommended () {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if ((!type.isEmpty() && type != null) || (type.equals("admin") && user != null && !user.isEmpty()) ||
			...
			try {
				...
				res = RecursoDAO.getRecursosRecomendados(4, idadeParaFaixaEtaria);
